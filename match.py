...
class match_class:
        ###
        def __init__(self, player1, player2 , ranked): #constructor . Needs to be modified so that it takes two paramters, Player1 name and Player2 name which will be entered prior to the start of the game
