...
class bracket():
    ...
    def setupui(self):
        ...
        self.qf_winners = list()
        self.qf_scores = list()

        self.sf_winners = list()
        self.sf_scores = list()

        

        self.players_labels.append(self.p1_name_label)
        self.players_labels.append(self.p2_name_label)
        self.players_labels.append(self.p3_name_label)
        self.players_labels.append(self.p4_name_label)
        self.players_labels.append(self.p5_name_label)
        self.players_labels.append(self.p6_name_label)
        self.players_labels.append(self.p7_name_label)
        self.players_labels.append(self.p8_name_label)

        self.qf_winners.append(self.qf1_name_label)
        self.qf_winners.append(self.qf2_name_label)
        self.qf_winners.append(self.qf3_name_label)
        self.qf_winners.append(self.qf4_name_label)

        self.sf_winners.append(self.sf1_name_label)
        self.sf_winners.append(self.sf2_name_label)

        self.players_scores.append(self.p1_score_label)
        self.players_scores.append(self.p2_score_label)
        self.players_scores.append(self.p3_score_label)
        self.players_scores.append(self.p4_score_label)
        self.players_scores.append(self.p5_score_label)
        self.players_scores.append(self.p6_score_label)
        self.players_scores.append(self.p7_score_label)
        self.players_scores.append(self.p8_score_label)

        self.qf_scores.append(self.qf1_score_label)
        self.qf_scores.append(self.qf2_score_label)
        self.qf_scores.append(self.qf3_score_label)
        self.qf_scores.append(self.qf4_score_label)

        self.sf_scores.append(self.sf1_score_label)
        self.sf_scores.append(self.sf2_score_label)
